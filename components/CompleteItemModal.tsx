        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white p-8 rounded-3xl w-full max-w-sm shadow-2xl relative animate-in zoom-in duration-200 text-black">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="text-xs font-bold text-gray-400 ml-1 mb-1 block">Select Photo</label>
                        <div className="relative border-2 border-dashed border-gray-200 rounded-2xl p-2 text-center hover:bg-gray-50 hover:border-green-300 transition-all group">
                            ...
                            {previewUrl ? (
                                ...
                                <div className="py-8">
                                    ...
                                    <p className="text-sm text-gray-500 font-bold">Upload Photo</p>
                                </div>
                            )}
                        </div>
                    </div>
                    <textarea
                        ...
                        placeholder="How was your amazing experience?"
                        value={reflection}
                ...
                <div className="flex gap-2 mt-6">
                    <button onClick={() => setIsCompleteModalOpen(false)} className="flex-1 text-gray-400 font-bold" disabled={uploading}>Back</button>
                    <button
